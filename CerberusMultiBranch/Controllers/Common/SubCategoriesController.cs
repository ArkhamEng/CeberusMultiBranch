...
namespace CerberusMultiBranch.Controllers.Common
{
    public class SubCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubCategoryId,CategoryId,Name,UnitMeasure")] SubCategory subCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubCategoryId,CategoryId,Name,UnitMeasure")] SubCategory subCategory)
        {
            if (ModelState.IsValid)
            {
